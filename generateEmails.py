...
import openai
import pickle
openai.api_key = "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"


prompt = """
Imagine you are an email introduction generation tool.
Example 1: Given the inputs
"{
...
Now write another introduction email given the following input:
"{
VC Name: Nabeel Hyatt,
Team: Robert Wachen,
Company: We use AI to add autocomplete to websites.
}"
...
x = openai.Completion.create(
    model="text-curie-001", # change for each type of model
    prompt = prompt,
    max_tokens=256,
    temperature=0.7,
    top_p=1,
...
# For ChatGPT 3.5 use different completion
